...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Momofy — India's Fastest Growing Momo Franchise",
    description: "Frozen momos wholesale & franchise. FSSAI certified. Pan India delivery.",
  },
};
  ...
  return (
    <html lang="en" className={`${syne.variable} ${dmSans.variable}`}>
      <body className="font-dm antialiased">
        ...
        <a
          href={`https://wa.me/${process.env.NEXT_PUBLIC_WA_NUMBER ?? "918867361454"}?text=${encodeURIComponent("Hi Momofy! I'm interested in your franchise/B2B supply. Please share more details.")}`}
          target="_blank"
